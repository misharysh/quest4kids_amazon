...
import { IsEmail, IsOptional, IsString, Matches, MinLength, Validate, ValidationArguments, ValidatorConstraint, ValidatorConstraintInterface } from "class-validator";
import { ApiProperty } from "@nestjs/swagger";

@ValidatorConstraint({name: 'passwordsDependency', async: false})
export class PasswordsDependencyConstraint implements ValidatorConstraintInterface
{
