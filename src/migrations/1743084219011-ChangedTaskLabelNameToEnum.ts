...
export class ChangedTaskLabelNameToEnum1743084219011 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."task_label_name_enum" AS ENUM('Home', 'School', 'Sports', 'Art', 'Music', 'Reading', 'Friends', 'Family', 'Science', 'Coding', 'Nature')`);
        await queryRunner.query(`ALTER TABLE "task_label" ADD "name" "public"."task_label_name_enum" NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "task_label" ADD "name" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "task_label" ADD CONSTRAINT "UQ_93a72d5d7e5370002fd7a237fd9" UNIQUE ("name", "taskId")`);
    }
