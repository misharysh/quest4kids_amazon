...
export class RemoveNameConstraintFromTaskLabeEntity1743085168738
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "task_label" ADD CONSTRAINT "UQ_93a72d5d7e5370002fd7a237fd9" UNIQUE ("taskId", "name")`,
    );
  }
}
